...
files=['manifest.json','LICENSE','THIRD-PARTY-LICENSE.txt','README.md']+[f'src/{name}' for name in ['content_script.js','popup.html','popup.css','popup.js','options.html','options.css','options.js']]+[f'assets/icons/icon{n}.png' for n in [16,32,48,128]]
for name in files:
